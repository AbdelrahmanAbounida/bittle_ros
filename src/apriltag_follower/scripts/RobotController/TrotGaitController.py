...
class TrotGaitController(GaitController):
    def __init__(self, default_stance, stance_time, swing_time, time_step, use_imu):
        ...
        self.max_y_velocity = 0 # 0.015 #[m/s] ##################
        self.max_yaw_rate = 0 # 0.6 #[rad/s]  ##################

        # Moving Left
        # self.max_x_velocity = 0.0 #[m/s]  # 
        # self.max_y_velocity = 0.15 #[m/s] # 
        ...
        # Moving Forward
        # self.max_x_velocity = 0.15 #[m/s]  # 
        # self.max_y_velocity = 0.0 #[m/s] # 
        # self.max_yaw_rate = 0.0 #[rad/s] # 
